...
export default class UnLockCommand extends Command<CommandPayload> {
	public constructor() {
		super({
			name: "unlock",
	...
	public async chatInput(interaction: ChatInputCommandInteraction) {
		...
		if (
			...
			await interaction.editReply({
				content: `${Emoji.Error} This channel is already unlocked, try with another.`,
			});
			return;
		}
		...
		await interaction.editReply({
			content: `${Emoji.Success} The channel has been successfully unlocked.`,
		});
	}
}
